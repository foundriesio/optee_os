...
def session_open(subsystem, connection_data, connection_type):
...
def parse_in_args():
    ...
    optional.add_argument('--subsystem', default="se050",
...
def main():
    ...
    # Open a new session
    session = session_open(args.subsystem, args.connection_data, args.connection_type)
    if session is None:
        return
