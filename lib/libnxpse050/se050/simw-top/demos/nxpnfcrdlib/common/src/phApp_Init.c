...
#if defined(PHDRIVER_KINETIS_K82) || defined(PHDRIVER_KINETIS_K64F)
#include <fsl_port.h>
#include <fsl_pit.h>
...
#include <fsl_clock.h>
#endif
#endif /* defined(PHDRIVER_KINETIS_K82) || defined(PHDRIVER_KINETIS_K64F) */


#if defined(PHDRIVER_IMXRT_1050)
#include <fsl_gpio.h>
#include <fsl_pit.h>
//#include <fsl_debug_console.h>
#ifdef DEBUG
...
#if defined(PHDRIVER_KINETIS_K64F)
    NVIC_SetPriority(EINT_IRQn, EINT_PRIORITY);
    NVIC_ClearPendingIRQ(EINT_IRQn);
    EnableIRQ(EINT_IRQn);
    __enable_irq();
#endif /* PHDRIVER_KINETIS_K64F */

#if defined( PHDRIVER_LPC55S69) || defined(PHDRIVER_IMXRT_1050) || defined(PHDRIVER_KINETIS_K82)
    NVIC_SetPriority(EINT_IRQn, EINT_PRIORITY);
    NVIC_ClearPendingIRQ(EINT_IRQn);
    EnableIRQ(EINT_IRQn);
#endif /* defined( PHDRIVER_LPC55S69) || defined(PHDRIVER_IMXRT_1050) || defined(PHDRIVER_KINETIS_K82) */
