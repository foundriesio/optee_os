...
#) Refer to :ref:`cli-tool` for pyCLI tool setup. Using pycli tool, provision server certificate and key into SE050 and create a reference pem file for server key ::
