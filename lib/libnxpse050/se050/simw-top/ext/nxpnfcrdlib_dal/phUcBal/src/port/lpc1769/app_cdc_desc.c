...
#ifdef USB_CDC_idVendor
    WBVAL(USB_CDC_idVendor),            /* idVendor */
#else
    WBVAL(0xFFFF),                      /* idVendor */
#endif
#ifdef USB_CDC_idProduct
    WBVAL(USB_CDC_idProduct),           /* idProduct */
#else
    WBVAL(0x0105),                      /* idProduct */
#endif
#if defined(USB_CDC_bcdDevice)
    WBVAL(USB_CDC_bcdDevice),           /* bcdDevice */
#else
...
ALIGNED(4) const uint8_t USB_StringDescriptor[] = {
    ...
    (6 * 2 + 2),                        /* bLength (X Char + Type + lenght) */
    USB_STRING_DESCRIPTOR_TYPE,         /* bDescriptorType */
    'N', 0,
    'X', 0,
    'P', 0,
    ...
    ( 18 * 2 + 2),                       /* bLength (X Char + Type + lenght) */
    USB_STRING_DESCRIPTOR_TYPE,         /* bDescriptorType */
    'N', 0, //1
    'x', 0, //2
    'p', 0, //3
