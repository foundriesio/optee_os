...
IF(WithHost_evkbimxrt1050 AND SSS_HAVE_APPLET)
    IF(NOT (WithSMCOM_SCI2C OR WithSMCOM_T1oI2C OR WithSMCOM_T1oI2C_GP1_0))
        MESSAGE(
            FATAL_ERROR
                "One of 'WithSMCOM_SCI2C, WithSMCOM_T1oI2C, WithSMCOM_T1oI2C_GP1_0' must be set[for WithHost_evkbimxrt1050 AND SSS_HAVE_APPLET]."
        )
    ENDIF()
ENDIF(WithHost_evkbimxrt1050 AND SSS_HAVE_APPLET)
...
IF(SSS_HAVE_APPLET_SE05X_IOT)
    IF(SSS_HAVE_SE05X_VER_04_12)
         SET(SSS_HAVE_SE05X_VER_GTE_04_12 ON)
         SET(SSS_HAVE_SE05X_VER_GTE_04_08 ON)
         SET(SSS_HAVE_SE05X_VER_GTE_04_04 ON)
         SET(SSS_HAVE_SE05X_VER_GTE_03_XX ON)
    ENDIF()

    IF(SSS_HAVE_SE05X_VER_04_08)
         SET(SSS_HAVE_SE05X_VER_GTE_04_12 OFF)
         SET(SSS_HAVE_SE05X_VER_GTE_04_08 ON)
         SET(SSS_HAVE_SE05X_VER_GTE_04_04 ON)
         SET(SSS_HAVE_SE05X_VER_GTE_03_XX ON)
    ENDIF()
    ...
    IF(SSS_HAVE_SE05X_VER_04_04)
         SET(SSS_HAVE_SE05X_VER_GTE_04_12 OFF)
         SET(SSS_HAVE_SE05X_VER_GTE_04_08 OFF)
         SET(SSS_HAVE_SE05X_VER_GTE_04_04 ON)
         SET(SSS_HAVE_SE05X_VER_GTE_03_XX ON)
    ENDIF()
    ...
    IF(SSS_HAVE_SE05X_VER_03_XX)
         SET(SSS_HAVE_SE05X_VER_GTE_04_12 OFF)
         SET(SSS_HAVE_SE05X_VER_GTE_04_08 OFF)
         SET(SSS_HAVE_SE05X_VER_GTE_04_04 OFF)
         SET(SSS_HAVE_SE05X_VER_GTE_03_XX ON)
    ENDIF()
