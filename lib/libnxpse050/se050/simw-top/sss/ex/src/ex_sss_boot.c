...
#if SSS_HAVE_HOSTCRYPTO_ANY && defined(EXFL_SE050_AUTH_UserID_PlatfSCP03) || defined(EXFL_SE050_AUTH_AESKey_PlatfSCP03) || \
...
static void free_auth_objects(SE_Connect_Ctx_t * pConnectCtx) {
    ...
    if (pConnectCtx->auth.authType == kSSS_AuthType_SCP03 ||
