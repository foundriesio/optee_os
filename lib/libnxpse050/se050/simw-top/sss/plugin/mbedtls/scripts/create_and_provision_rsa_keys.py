...
def printUsage():
    ...
    print('Run as -  create_and_provision_rsa_keys.py  <keyType> <connection_type> <connection_string>')
    ...
    print('Example invocation - create_and_provision_rsa_keys.py rsa2048 t1oi2c none')
