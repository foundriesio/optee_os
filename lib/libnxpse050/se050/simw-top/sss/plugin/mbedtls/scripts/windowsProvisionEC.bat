...
@REM Provision using pycli tool
...
) else if "%IOT_SE%" == "se050" (
    echo %ssscli% -v connect se050 %CONNECTION_TYPE% %CONNECTION_PARAM%
    %ssscli% -v connect se050 %CONNECTION_TYPE% %CONNECTION_PARAM%
...
:SUPPORTED_KEYTYPES
    ...
    echo 'Please provide as fourth argument: Iot SE  - eg. a71ch , Default:se050'
