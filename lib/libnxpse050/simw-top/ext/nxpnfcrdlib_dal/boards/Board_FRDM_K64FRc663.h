...
#ifndef BOARD_FRDM_K64FRC663_H_
#define BOARD_FRDM_K64FRC663_H_
 ...
 * |  --   |  --   | GPIO/PORT  | PIN   |
 * */
#define PHDRIVER_PIN_RESET  ((GPIO_PORT_C << 8) | 12)  /**< Reset pin, Pin13, GPIOA, PORTA */
#define PHDRIVER_PIN_IRQ    ((GPIO_PORT_C << 8) | 4)   /**< IRQ pin, Pin7, GPIOC, PORTC */
...
#define ENABLE_PORT_SSP_1     kCLOCK_PortD
#define PORT_SSP_1            PORTD
#define FIRST_PINNUM_SSP      1

#define ENABLE_PORT_SSP_2     kCLOCK_PortD
#define PORT_SSP_2            PORTD
#define SECOND_PINNUM_SSP     2

#define ENABLE_PORT_SSP_3     kCLOCK_PortD
#define PORT_SSP_3            PORTD
#define THIRD_PINNUM_SSP      3

#define PHDRIVER_PIN_SSEL     ((GPIO_PORT_D << 8) | 0)  /**< Reset pin, Pin14, GPIOA, PORTA */
