...
#endif /* VERBOSE_APDU_LOGS */
    tlvRet = TLVSET_Variant("variant", &pCmdbuf, &cmdbufLen, kSE05x_TAG_1, variant);
    if (0 != tlvRet) {
        goto cleanup;
    }
    retStatus = DoAPDUTx_s_Case3(session_ctx, &hdr, cmdbuf, cmdbufLen);
...
#endif /* VERBOSE_APDU_LOGS */
    tlvRet = TLVSET_U32("keyPairId", &pCmdbuf, &cmdbufLen, kSE05x_TAG_1, keyPairId);
    if (0 != tlvRet) {
        goto cleanup;
    }
    tlvRet = TLVSET_U32("pskId", &pCmdbuf, &cmdbufLen, kSE05x_TAG_2, pskId);
    if (0 != tlvRet) {
        goto cleanup;
    }
