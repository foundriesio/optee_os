...
def ecc(cli_ctx, keyid, curvetype):
    """ Generate ECC Key \n
    ...
    try:
        ...
        status = func_timeout.func_timeout(TIME_OUT, gen_obj.gen_ecc_pair,
                                           (keyid, ECC_CURVE_TYPE[curvetype], None))
...
def pub(cli_ctx, keyid, curvetype, filename, format):  # pylint: disable=redefined-builtin
    """
