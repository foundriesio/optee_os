...
AUTH_TYPE_MAP = {
    "None": [apis.kSE05x_AuthType_None, 0],
    "PlatformSCP": [apis.kSE05x_AuthType_SCP03, 0],
    "UserID": [apis.kSE05x_AuthType_UserID, authkey.SE050_AUTHID_USER_ID],
    "ECKey": [apis.kSE05x_AuthType_ECKey, authkey.SE050_AUTHID_ECKEY],
    "AESKey": [apis.kSE05x_AuthType_AESKey, authkey.SE050_AUTHID_AESKEY],
}


CRYPT_ALGO = {
    'oaep': apis.kAlgorithm_SSS_RSAES_PKCS1_OAEP_SHA1,
    'rsaes': apis.kAlgorithm_SSS_RSAES_PKCS1_V1_5_SHA256,
}
