...
ELSEIF(WithHost_evkbimxrt1050)
    SET(WithKSDK ON)
    SET(KSDK_BoardName "evkbimxrt1050")
    SET(KSDK_CPUName "MIMXRT1052")
    ADD_DEFINITIONS(-DLPC_ENET) # .. Purnank : FIXME To be removed
...
IF(SSS_HAVE_APPLET_SE05X_IOT)
    ...
    MACRO(EXPOSE_SE05X_AUTH_STRATEGY DEFINE_PREFIX)
        SET(NEED_AUTH OFF)
        SET(NEED_CRYPTO OFF)
        SET(NEED_ECKey OFF)
        IF("${SE05X_Auth}" STREQUAL "None")
            TARGET_COMPILE_DEFINITIONS(${PROJECT_NAME} PRIVATE ${DEFINE_PREFIX}_NONE)
        ELSEIF("${SE05X_Auth}" STREQUAL "PlatfSCP03")
            SET(NEED_CRYPTO ON)
            TARGET_COMPILE_DEFINITIONS(${PROJECT_NAME} PRIVATE ${DEFINE_PREFIX}_${SE05X_Auth})
