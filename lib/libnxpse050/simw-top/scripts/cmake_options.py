...
LIST_APPLETS = [
    ...
    # ("SE051_C", "SE051 With Iot and MALS Applet", True),
...
LIST_HOST = [
    ...
    ("evkbimxrt1050", "Embedded Kinetis i.MX RT 1050", True),
...
ALL_VALUES = [
    ...
    ("SE05X_Ver", "03_XX",
      (
        "SE50 Applet version.", "", "03_XX would only enable features of version 03.XX version of applet.",
...
def VCOM_Delete_and_provision(binary_path="") {
    try
    {
        timeout(15) {
            if (binary_path == ""){
                binary_path="%WORKSPACE%/src/binaries/tst"
            }
            bat """
