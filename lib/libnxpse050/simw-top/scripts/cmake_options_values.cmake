...
IF(NXPInternal)
    SET_PROPERTY(
        ...
        PROPERTY
            STRINGS
            "Darwin;PCLinux32;PCLinux64;PCWindows;Cygwin;frdmk64f;evkbimxrt1050;lpcxpresso55s;lpcxpresso55s_ns;lpcxpresso55s_s;iMXLinux;Raspbian;Android;Win10IoT;"
    )
ELSE()
    SET_PROPERTY(
        CACHE Host
        PROPERTY
            STRINGS
            "Darwin;PCLinux32;PCLinux64;PCWindows;Cygwin;frdmk64f;evkbimxrt1050;lpcxpresso55s;lpcxpresso55s_ns;lpcxpresso55s_s;iMXLinux;Raspbian;Android;"
    )
ENDIF()
...
IF("${SE05X_Ver}" STREQUAL "04_04")
    SET(WithSE05X_Ver_04_04 ON)
    SET(SSS_HAVE_SE05X_VER_04_04 "1")
ELSE()
    SET(WithSE05X_Ver_04_04 OFF)
    SET(SSS_HAVE_SE05X_VER_04_04 "0")
ENDIF()

IF("${SE05X_Ver}" STREQUAL "04_08")
    SET(WithSE05X_Ver_04_08 ON)
    SET(SSS_HAVE_SE05X_VER_04_08 "1")
ELSE()
    SET(WithSE05X_Ver_04_08 OFF)
    SET(SSS_HAVE_SE05X_VER_04_08 "0")
ENDIF()

IF("${SE05X_Ver}" STREQUAL "04_12")
    SET(WithSE05X_Ver_04_12 ON)
    SET(SSS_HAVE_SE05X_VER_04_12 "1")
ELSE()
    SET(WithSE05X_Ver_04_12 OFF)
    SET(SSS_HAVE_SE05X_VER_04_12 "0")
ENDIF()

IF("${SE05X_Ver}" STREQUAL "03_XX")
    # OK
ELSEIF("${SE05X_Ver}" STREQUAL "04_04")
    # OK
ELSEIF("${SE05X_Ver}" STREQUAL "04_08")
    # OK
ELSEIF("${SE05X_Ver}" STREQUAL "04_12")
    # OK
ELSE()
    MESSAGE(SEND_ERROR "For 'SE05X_Ver' '${SE05X_Ver}' is invalid.")
    MESSAGE(STATUS "Only supported values are '03_XX, 04_04, 04_08, 04_12'")
ENDIF()
...
IF("${Host}" STREQUAL "evkbimxrt1050")
    SET(WithHost_evkbimxrt1050 ON)
    SET(SSS_HAVE_HOST_EVKBIMXRT1050 "1")
ELSE()
    SET(WithHost_evkbimxrt1050 OFF)
    SET(SSS_HAVE_HOST_EVKBIMXRT1050 "0")
ENDIF()
...
ELSEIF("${Host}" STREQUAL "frdmk64f")
    # OK
ELSEIF("${Host}" STREQUAL "evkbimxrt1050")
    # OK
...
ELSE()
    ...
    MESSAGE(STATUS "Only supported values are 'Darwin, PCLinux32, PCLinux64, PCWindows, Cygwin, frdmk64f, evkbimxrt1050, lpcxpresso55s, lpcxpresso55s_ns, lpcxpresso55s_s, iMXLinux, Raspbian, Android, Win10IoT'")
ENDIF()
