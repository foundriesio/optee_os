...
#ifndef FSL_SSS_MBEDTLS_APIS_HPP_H
#define FSL_SSS_MBEDTLS_APIS_HPP_H
...
class SESSION_MBEDTLS : public I_session {
   protected:
    sss_mbedtls_session_t ctx;
...
class KEYOBJ_MBEDTLS : public I_keyobj {
   protected:
    sss_mbedtls_object_t ctx;
...
class KEYDERIVE_MBEDTLS : public I_keyderive {
   protected:
    sss_mbedtls_derive_key_t ctx;
...
class KEYSTORE_MBEDTLS : public I_keystore {
   protected:
    sss_mbedtls_key_store_t ctx;
...
class ASYM_MBEDTLS : public I_asym {
   protected:
    sss_mbedtls_asymmetric_t ctx;
...
class SYMM_MBEDTLS : public I_symm {
   protected:
    sss_mbedtls_symmetric_t ctx;
...
class AEAD_MBEDTLS : public I_aead {
   protected:
    sss_mbedtls_aead_t ctx;
...
class MAC_MBEDTLS : public I_mac {
   protected:
    sss_mbedtls_mac_t ctx;
...
class MD_MBEDTLS : public I_md {
   protected:
    sss_mbedtls_digest_t ctx;
...
class RNG_MBEDTLS : public I_rng {
   protected:
    sss_mbedtls_rng_context_t ctx;
...
#endif /* FSL_SSS_MBEDTLS_APIS_HPP_H */
