...
def printUsage():
    ...
    print('Run as -  create_and_provision_ecc_keys.py  <keyType> <connection_type> <connection_string> <iot_se (optional. Default - se050)>')
    ...
    print('Example invocation - create_and_provision_ecc_keys.py prime256v1 t1oi2c none se050')
...
session_close(None)
session = session_open(iot_se, connection_string, connection_type)
if session is None:
