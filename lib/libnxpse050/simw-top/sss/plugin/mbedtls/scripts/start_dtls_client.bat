...
@REM echo ..\..\..\..\tools\mbedtls_ex_sss_dtls_client.exe %P_MBED% %P_MBED_CLIENT% %P_ciphersuite% %P_curve% %~3
..\..\..\..\tools\mbedtls_ex_sss_dtls_client.exe %P_MBED% %P_MBED_CLIENT% %P_ciphersuite% %P_curve% %~3
goto :EOF
