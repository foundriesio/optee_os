...
#define SSS_ALGORITHM_IS_RSA_PKCS1_V1_5_ENCRYPT(algorithm) \
    ((algorithm >= kAlgorithm_SSS_RSAES_PKCS1_V1_5_SHA1) && (algorithm <= kAlgorithm_SSS_RSAES_PKCS1_V1_5_SHA512))
